...
export default function LandingPage() {
  ...
  return (
    <>
      ...
      <section className="demo-section" suppressHydrationWarning style={{ padding: "80px 24px 0", display: "flex", flexDirection: "column", alignItems: "center", perspective: "1200px" }}>
        <div
          id="demoFrame"
        ...
        >
          ...
          <div style={{ position: "relative", lineHeight: 0 }}>
            <video
              src="https://res.cloudinary.com/dqsk5btgz/video/upload/v1777840357/newdemoblack_xgwubv.mov"
              autoPlay
              muted
              loop
              playsInline
        ...
        <div className="reveal" style={{ background: "#111", borderRadius: 16, boxShadow: "0 4px 40px rgba(0,0,0,0.4)", overflow: "hidden", maxWidth: 720, margin: "0" }}>
          ...
          <div style={{ padding: "28px 40px 36px", display: "flex", flexDirection: "column", gap: 28 }}>
            ...
            <div style={{ padding: "0", background: "none" }}>
              <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.1em", color: "#999", marginBottom: 8, textTransform: "uppercase", fontFamily: "'Inter', sans-serif" }}>Verdict</div>
            ...
            {/* NEXT 48 HOURS */}
            <div>
              <h3 style={{ fontSize: 11, fontWeight: 700, color: "#999", letterSpacing: "0.06em", textTransform: "uppercase", fontFamily: "'Inter', sans-serif", margin: "0 0 10px" }}>Next 48 Hours</h3>
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            ...
            {/* THE QUESTION */}
            <div style={{ padding: "16px 0", background: "none", borderLeft: "none" }}>
      ...
      <section className="pricing-section" id="pricing">
        ...
        <div className="pricing-grid reveal">
          <div className="pricing-card">
            ...
            <button type="button" className="pricing-btn pricing-btn-dark" onClick={() => { void fetch("/api/create-checkout", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ priceId: "price_1TQzvsFC3qsxzaqxr3ydKYDS" }) }).then(r => r.json()).then(d => { if (d.url) window.location.href = d.url; }).catch(() => { window.location.href = "/auth"; }); }}>{t.pricing_oneshot_cta}</button>
