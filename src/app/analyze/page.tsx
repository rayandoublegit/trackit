...
export default function AnalyzePage() {
  ...
  const t = {
    en: {
      ...
      step7_title: "Is this idea already generating revenue? If yes, how much per month?",
      step7_sub: "Even $1 of revenue changes everything. Be exact.",
      step_next: "OK, NEXT →",
      step_back: "← Back",
    ...
    fr: {
      ...
      step7_title: "Cette idée génère-t-elle déjà des revenus ? Si oui, combien par mois ?",
      step7_sub: "Même 1€ de revenu change tout. Sois précis.",
