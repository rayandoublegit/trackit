    ...
    return (
      <div style={{ minHeight: "100vh", background: theme.bg, display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 32 }}>
          <img src={darkMode ? "/images/navbarlogo.png" : "/images/klayanblack.png"} alt="Klayan" style={{ height: 48, marginBottom: 8 }} />
          <div style={{ textAlign: "center" }}>
      ...
      <div style={{ width: 760, maxWidth: "calc(100vw - 48px)", margin: "0 auto", background: theme.card, borderRadius: 16, boxShadow: theme.shadow, overflow: "hidden" }}>
        ...
        <div style={{ padding: "48px 56px 56px" }}>
          ...
          <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", alignItems: "flex-start", justifyContent: "space-between", gap: 16, marginBottom: 32 }}>
            <div style={{ display: "flex", flexDirection: "column", gap: 8, alignItems: "flex-start", width: isMobile ? "100%" : "auto" }}>
