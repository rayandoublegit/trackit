...
const settingsT: Record<SettingsLang, Record<string, string>> = {
  en: {
    ...
    analyses_free: "1 free analysis included",
    analyses_spark: "$19/mo · 3 analyses/month",
    analyses_build: "$69/mo · 10 analyses/month",
    analyses_scale: "$149/mo · Unlimited analyses",
  ...
  fr: {
    ...
    analyses_free: "1 analyse gratuite incluse",
    analyses_spark: "19€/mois · 3 analyses/mois",
    analyses_build: "69€/mois · 10 analyses/mois",
    analyses_scale: "149€/mois · Analyses illimitées",
