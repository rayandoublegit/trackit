        ...
        <div className="nav-right" style={{ gap: 3 }}>
          <ul className="nav-links">
            <li style={{ position: "relative" }} ref={featuresRef}>
              ...
              {featuresOpen && (
                <div style={{ position: "absolute", top: "calc(100% + 16px)", left: "50%", transform: "translateX(-50%)", background: "#111", borderRadius: 16, boxShadow: "0 8px 40px rgba(0,0,0,0.5)", padding: 16, zIndex: 9999, width: 640, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, border: "1px solid rgba(255,255,255,0.08)", left: "auto", right: 0, transform: "none" }}>
                  {[
