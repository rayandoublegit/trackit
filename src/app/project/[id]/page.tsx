...
export default function ProjectPage() {
  ...
  const ReportDisplay = ({ report }: { report: string }) => {
    const lines = report.replace(/\*\*/g, "").replace(/^#+\s/gm, "").replace(/^\*\s/gm, "").replace(/^-\s/gm, "").trim().split("\n");
    return (
      <div style={{ fontSize: 14, lineHeight: 1.8, fontFamily: "'Europa Grotesk No 2 SH', sans-serif" }}>
        {lines.map((line, i) => {
          const isTitle = line.trim() === line.trim().toUpperCase() && line.trim().length > 2 && /[A-Z]/.test(line);
          return (
            <div key={i} style={{ color: isTitle ? (D ? "rgba(255,255,255,0.95)" : "rgba(0,0,0,0.95)") : (D ? "rgba(255,255,255,0.75)" : "rgba(0,0,0,0.75)"), fontWeight: isTitle ? 700 : 400, marginTop: isTitle && i > 0 ? 12 : 0 }}>
              {line || " "}
            </div>
          );
        })}
              ...
              <div>
                ...
                {checkinReport && (
                  <div style={{ background: th.cardBg, border: `1px solid #4ade8033`, borderRadius: 12, padding: "24px", marginBottom: 24 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16 }}><img src="/images/navbarlogo.png" alt="Klayan" style={{ width: 28, height: 28, objectFit: "contain" }} /><div style={{ fontSize: 14, fontWeight: 600, color: "#4ade80" }}>{t.checkin_report_title}</div></div>
          ...
          {activeTab === "competitor" && (
            canAccess("build") ? (
              <div>
                ...
                {competitorReport ? (
                  <div style={{ background: th.cardBg, border: `1px solid ${th.cardBorder}`, borderRadius: 12, overflow: "hidden", marginBottom: 16 }}><div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 20px", borderBottom: collapsedReports["competitor"] ? "none" : `1px solid ${th.cardBorder}`, cursor: "pointer" }} onClick={() => setCollapsedReports(p => ({ ...p, "competitor": !p["competitor"] }))}><div style={{ display: "flex", alignItems: "center" }}><img src="/images/navbarlogo.png" alt="Klayan" style={{ width: 18, height: 18, objectFit: "contain", marginRight: 6 }} /><span style={{ fontSize: 12, fontWeight: 600, color: th.textMuted }}>{lang === "fr" ? "Résultat" : "Output"}</span></div><div style={{ display: "flex", alignItems: "center", gap: 8 }}><button type="button" onClick={e => { e.stopPropagation(); void deleteReport("competitor"); }} style={{ background: "none", border: "none", color: th.textMuted, cursor: "pointer", padding: "2px 4px" }} onMouseEnter={e => e.currentTarget.style.color = "#f87171"} onMouseLeave={e => e.currentTarget.style.color = th.textMuted}><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 01-2 2H8a2 2 0 01-2-2L5 6"/><path d="M10 11v6M14 11v6"/></svg></button><span style={{ fontSize: 11, color: th.textMuted }}>{collapsedReports["competitor"] ? "▼" : "▲"}</span></div></div>{!collapsedReports["competitor"] && <div style={{ padding: "20px" }}><ReportDisplay report={competitorReport} /></div>}</div>
                ) : !runningCompetitor && (
                  <div style={{ textAlign: "center", padding: "48px", color: th.textMuted, fontSize: 14 }}>
          ...
          {activeTab === "pivot" && (
            canAccess("build") ? (
              <div>
                ...
                {pivotReport ? (
                  <div style={{ background: th.cardBg, border: `1px solid ${th.cardBorder}`, borderRadius: 12, overflow: "hidden", marginBottom: 16 }}><div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 20px", borderBottom: collapsedReports["pivot"] ? "none" : `1px solid ${th.cardBorder}`, cursor: "pointer" }} onClick={() => setCollapsedReports(p => ({ ...p, "pivot": !p["pivot"] }))}><div style={{ display: "flex", alignItems: "center" }}><img src="/images/navbarlogo.png" alt="Klayan" style={{ width: 18, height: 18, objectFit: "contain", marginRight: 6 }} /><span style={{ fontSize: 12, fontWeight: 600, color: th.textMuted }}>{lang === "fr" ? "Résultat" : "Output"}</span></div><div style={{ display: "flex", alignItems: "center", gap: 8 }}><button type="button" onClick={e => { e.stopPropagation(); void deleteReport("pivot"); }} style={{ background: "none", border: "none", color: th.textMuted, cursor: "pointer", padding: "2px 4px" }} onMouseEnter={e => e.currentTarget.style.color = "#f87171"} onMouseLeave={e => e.currentTarget.style.color = th.textMuted}><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 01-2 2H8a2 2 0 01-2-2L5 6"/><path d="M10 11v6M14 11v6"/></svg></button><span style={{ fontSize: 11, color: th.textMuted }}>{collapsedReports["pivot"] ? "▼" : "▲"}</span></div></div>{!collapsedReports["pivot"] && <div style={{ padding: "20px" }}><ReportDisplay report={pivotReport} /></div>}</div>
                ) : !runningPivot && (
                  <div style={{ textAlign: "center", padding: "48px", color: th.textMuted, fontSize: 14 }}>
          ...
          {activeTab === "marketing" && (
            canAccess("build") ? (
              <div>
                ...
                {marketingReport ? (
                  <div style={{ background: th.cardBg, border: `1px solid ${th.cardBorder}`, borderRadius: 12, overflow: "hidden", marginBottom: 16 }}><div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 20px", borderBottom: collapsedReports["marketing"] ? "none" : `1px solid ${th.cardBorder}`, cursor: "pointer" }} onClick={() => setCollapsedReports(p => ({ ...p, "marketing": !p["marketing"] }))}><div style={{ display: "flex", alignItems: "center" }}><img src="/images/navbarlogo.png" alt="Klayan" style={{ width: 18, height: 18, objectFit: "contain", marginRight: 6 }} /><span style={{ fontSize: 12, fontWeight: 600, color: th.textMuted }}>{lang === "fr" ? "Résultat" : "Output"}</span></div><div style={{ display: "flex", alignItems: "center", gap: 8 }}><button type="button" onClick={e => { e.stopPropagation(); void deleteReport("marketing"); }} style={{ background: "none", border: "none", color: th.textMuted, cursor: "pointer", padding: "2px 4px" }} onMouseEnter={e => e.currentTarget.style.color = "#f87171"} onMouseLeave={e => e.currentTarget.style.color = th.textMuted}><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 01-2 2H8a2 2 0 01-2-2L5 6"/><path d="M10 11v6M14 11v6"/></svg></button><span style={{ fontSize: 11, color: th.textMuted }}>{collapsedReports["marketing"] ? "▼" : "▲"}</span></div></div>{!collapsedReports["marketing"] && <div style={{ padding: "20px" }}><ReportDisplay report={marketingReport} /></div>}</div>
                ) : !runningMarketing && (
                  <div style={{ textAlign: "center", padding: "48px", color: th.textMuted, fontSize: 14 }}>
          ...
          {activeTab === "outreach" && (
            canAccess("build") ? (
              <div>
                ...
                {outreachReport ? (
                  <div style={{ background: th.cardBg, border: `1px solid ${th.cardBorder}`, borderRadius: 12, overflow: "hidden", marginBottom: 16 }}><div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 20px", borderBottom: collapsedReports["outreach"] ? "none" : `1px solid ${th.cardBorder}`, cursor: "pointer" }} onClick={() => setCollapsedReports(p => ({ ...p, "outreach": !p["outreach"] }))}><div style={{ display: "flex", alignItems: "center" }}><img src="/images/navbarlogo.png" alt="Klayan" style={{ width: 18, height: 18, objectFit: "contain", marginRight: 6 }} /><span style={{ fontSize: 12, fontWeight: 600, color: th.textMuted }}>{lang === "fr" ? "Résultat" : "Output"}</span></div><div style={{ display: "flex", alignItems: "center", gap: 8 }}><button type="button" onClick={e => { e.stopPropagation(); void deleteReport("outreach"); }} style={{ background: "none", border: "none", color: th.textMuted, cursor: "pointer", padding: "2px 4px" }} onMouseEnter={e => e.currentTarget.style.color = "#f87171"} onMouseLeave={e => e.currentTarget.style.color = th.textMuted}><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 01-2 2H8a2 2 0 01-2-2L5 6"/><path d="M10 11v6M14 11v6"/></svg></button><span style={{ fontSize: 11, color: th.textMuted }}>{collapsedReports["outreach"] ? "▼" : "▲"}</span></div></div>{!collapsedReports["outreach"] && <div style={{ padding: "20px" }}><ReportDisplay report={outreachReport} /></div>}</div>
                ) : !runningOutreach && (
                  <div style={{ textAlign: "center", padding: "48px", color: th.textMuted, fontSize: 14 }}>
          ...
          {activeTab === "pricing" && (
            canAccess("build") ? (
              <div>
                ...
                {pricingReport ? (
                  <div style={{ background: th.cardBg, border: `1px solid ${th.cardBorder}`, borderRadius: 12, overflow: "hidden", marginBottom: 16 }}><div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 20px", borderBottom: collapsedReports["pricing"] ? "none" : `1px solid ${th.cardBorder}`, cursor: "pointer" }} onClick={() => setCollapsedReports(p => ({ ...p, "pricing": !p["pricing"] }))}><div style={{ display: "flex", alignItems: "center" }}><img src="/images/navbarlogo.png" alt="Klayan" style={{ width: 18, height: 18, objectFit: "contain", marginRight: 6 }} /><span style={{ fontSize: 12, fontWeight: 600, color: th.textMuted }}>{lang === "fr" ? "Résultat" : "Output"}</span></div><div style={{ display: "flex", alignItems: "center", gap: 8 }}><button type="button" onClick={e => { e.stopPropagation(); void deleteReport("pricing"); }} style={{ background: "none", border: "none", color: th.textMuted, cursor: "pointer", padding: "2px 4px" }} onMouseEnter={e => e.currentTarget.style.color = "#f87171"} onMouseLeave={e => e.currentTarget.style.color = th.textMuted}><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 01-2 2H8a2 2 0 01-2-2L5 6"/><path d="M10 11v6M14 11v6"/></svg></button><span style={{ fontSize: 11, color: th.textMuted }}>{collapsedReports["pricing"] ? "▼" : "▲"}</span></div></div>{!collapsedReports["pricing"] && <div style={{ padding: "20px" }}><ReportDisplay report={pricingReport} /></div>}</div>
                ) : !runningPricing && (
                  <div style={{ textAlign: "center", padding: "48px", color: th.textMuted, fontSize: 14 }}>
          ...
          {activeTab === "revenue" && (
            canAccess("build") ? (
              <div>
                ...
                {revenueReport ? (
                  <div style={{ background: th.cardBg, border: `1px solid ${th.cardBorder}`, borderRadius: 12, overflow: "hidden", marginBottom: 16 }}><div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 20px", borderBottom: collapsedReports["revenue"] ? "none" : `1px solid ${th.cardBorder}`, cursor: "pointer" }} onClick={() => setCollapsedReports(p => ({ ...p, "revenue": !p["revenue"] }))}><div style={{ display: "flex", alignItems: "center" }}><img src="/images/navbarlogo.png" alt="Klayan" style={{ width: 18, height: 18, objectFit: "contain", marginRight: 6 }} /><span style={{ fontSize: 12, fontWeight: 600, color: th.textMuted }}>{lang === "fr" ? "Résultat" : "Output"}</span></div><div style={{ display: "flex", alignItems: "center", gap: 8 }}><button type="button" onClick={e => { e.stopPropagation(); void deleteReport("revenue"); }} style={{ background: "none", border: "none", color: th.textMuted, cursor: "pointer", padding: "2px 4px" }} onMouseEnter={e => e.currentTarget.style.color = "#f87171"} onMouseLeave={e => e.currentTarget.style.color = th.textMuted}><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 01-2 2H8a2 2 0 01-2-2L5 6"/><path d="M10 11v6M14 11v6"/></svg></button><span style={{ fontSize: 11, color: th.textMuted }}>{collapsedReports["revenue"] ? "▼" : "▲"}</span></div></div>{!collapsedReports["revenue"] && <div style={{ padding: "20px" }}><ReportDisplay report={revenueReport} /></div>}</div>
                ) : !runningRevenue && (
                  <div style={{ textAlign: "center", padding: "48px", color: th.textMuted, fontSize: 14 }}>
