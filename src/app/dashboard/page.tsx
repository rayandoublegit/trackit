...
export default function DashboardPage() {
  ...
  return (
    ...
    >
      ...
      >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              <div style={{ width: 40, height: 40, borderRadius: "50%", background: "#1a1a1a", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, overflow: "hidden" }}>
                {avatarUrl ? (
                  ...
                  <span style={{ color: "#fff", fontSize: 16, fontWeight: 700, fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif" }}>
            ...
            <div ref={avatarMenuRef} style={{ position: "relative" }}>
              ...
              {showAvatarMenu && user ? (
                <div role="menu" style={{ position: "absolute", top: "calc(100% + 6px)", right: 0, zIndex: 200, minWidth: 180, background: theme.card, border: `1px solid ${theme.cardBorder}`, borderRadius: 12, padding: 6, boxShadow: "0 8px 24px rgba(0,0,0,0.1)" }}>
                  {avatarUrl ? (
                    <>
                      <button type="button" role="menuitem" disabled={avatarBusy} onClick={() => openAvatarFilePicker()} style={{ display: "flex", alignItems: "center", gap: 8, width: "100%", padding: "9px 10px", border: "none", borderRadius: 8, background: "transparent", color: theme.text, fontSize: 13, fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif", fontWeight: 500, cursor: avatarBusy ? "wait" : "pointer", textAlign: "left" }}>
                        <CameraIcon /> Change photo
                      </button>
                      <button type="button" role="menuitem" disabled={avatarBusy} onClick={() => void removeAvatar()} style={{ display: "flex", alignItems: "center", gap: 8, width: "100%", padding: "9px 10px", border: "none", borderRadius: 8, background: "transparent", color: "#ef4444", fontSize: 13, fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif", fontWeight: 500, cursor: avatarBusy ? "wait" : "pointer", textAlign: "left" }}>
        ...
        <div style={{ padding: "12px" }}>
          <button type="button" onClick={() => { setActiveTab("workspaces"); if (isMobile) setSidebarOpen(false); }}
            style={{ display: "flex", alignItems: "center", gap: 12, width: "100%", padding: "9px 12px", marginBottom: 4, background: activeTab === "workspaces" ? theme.activeNav : "transparent", border: `1px solid ${theme.cardBorder}`, borderRadius: 8, cursor: "pointer", fontSize: 14, fontWeight: 500, color: theme.text, fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif", boxSizing: "border-box" }}>
          ...
          <button type="button" onClick={() => setActiveTab("home")}
            style={{ display: "flex", alignItems: "center", gap: 12, width: "100%", padding: "9px 12px", marginBottom: 4, background: activeTab === "home" ? theme.activeNav : "transparent", border: "none", borderRadius: 8, textDecoration: "none", fontSize: 14, fontWeight: 500, color: theme.text, fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif", boxSizing: "border-box", cursor: "pointer" }} className="kly-nav-btn">
          ...
          <button type="button" onClick={() => { setActiveTab("ideas"); }}
            style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%", padding: "10px 12px", background: activeTab === "ideas" ? theme.activeNav : "transparent", border: "none", cursor: "pointer", borderRadius: 8, fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif", boxSizing: "border-box" }}
          ...
          <Link href="/analyze?resume=1"
              style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%", padding: "9px 12px", marginTop: 2, background: "transparent", border: "none", borderRadius: 8, textDecoration: "none", fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif", boxSizing: "border-box" }}
              className="kly-nav-btn">
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <Link href="/analyze"
            style={{ display: "flex", alignItems: "center", gap: 12, width: "100%", padding: "9px 12px", marginBottom: 2, background: "transparent", borderRadius: 8, textDecoration: "none", fontSize: 14, fontWeight: 500, color: theme.text, fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif", boxSizing: "border-box" }}
            className="kly-nav-btn">
          ...
          <button type="button" onClick={() => setActiveTab("trash" as any)}
            style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%", padding: "9px 12px", marginBottom: 8, background: (activeTab as string) === "trash" ? theme.activeNav : "transparent", border: "none", cursor: "pointer", borderRadius: 8, fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif", boxSizing: "border-box" }}
            className="kly-nav-btn">
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        ...
        <div style={{ padding: "0 12px 4px" }}>
          ...
          <button type="button" onClick={() => setActiveTab("settings" as any)}
            style={{ display: "flex", alignItems: "center", gap: 12, width: "100%", padding: "9px 12px", borderRadius: 8, border: "none", background: activeTab === "settings" ? theme.activeNav : "transparent", color: theme.text, fontSize: 14, fontWeight: 500, fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif", cursor: "pointer", textAlign: "left", boxSizing: "border-box" }}>
          ...
          <a href="https://discord.gg/nHVEPB2yXb" target="_blank" rel="noopener noreferrer"
            style={{ display: "flex", alignItems: "center", gap: 12, width: "100%", padding: "9px 12px", borderRadius: 8, textDecoration: "none", color: theme.text, fontSize: 14, fontWeight: 500, fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif" }}>
        ...
        <div style={{ padding: "0 12px 4px" }}>
          ...
          <button type="button" onClick={() => setActiveTab("profile" as any)}
            style={{ display: "flex", alignItems: "center", gap: 12, width: "100%", padding: "9px 12px", background: activeTab === "profile" ? theme.activeNav : "transparent", border: "none", borderRadius: 8, cursor: "pointer", fontSize: 14, fontWeight: 400, color: theme.text, fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif", textAlign: "left", boxSizing: "border-box" }}
            ...
            {userPlan === "scale" ? (
              ...
              <>
                ...
                <button type="button"
                  ...
                  style={{ display: "block", width: "100%", textAlign: "center", padding: "9px 14px", borderRadius: 8, border: "none", color: "#fff", fontSize: 13, fontWeight: 700, background: "#111", cursor: "pointer", fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif" }}>
                  {t.upgrade_now}
                </button>
              </>
            )}
      ...
      {/* Main */}
      <main suppressHydrationWarning style={{ flex: 1, minWidth: 0, background: theme.main, display: "flex", flexDirection: "column", minHeight: "100vh", fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, background: theme.inputBg, border: `1px solid ${theme.inputBorder}`, borderRadius: 8, padding: "7px 14px", minWidth: isMobile ? 0 : 220, width: isMobile ? "100%" : "auto" }}>
                ...
                <input ref={searchInputRef} type="text" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)}
                  placeholder={t.search} style={{ background: "transparent", border: "none", outline: "none", fontSize: 13, color: theme.text, width: "100%", fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif" }} />
                {searchQuery ? (
                  ...
                  <div style={{ position: "absolute", top: "calc(100% + 8px)", right: 0, zIndex: 200, width: 320, background: theme.dropdownBg, border: `1px solid ${theme.dropdownBorder}`, borderRadius: 12, boxShadow: "0 8px 24px rgba(0,0,0,0.15)", overflow: "hidden" }}>
                    <div style={{ padding: "14px 16px", borderBottom: `1px solid ${theme.divider}`, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                      ...
                      {notifications.some(n => !n.read_by.includes(user?.id ?? "")) && (
                        ...
                        }} style={{ fontSize: 12, color: theme.textMuted, background: "none", border: "none", cursor: "pointer", fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif" }}>
                          Mark all read
                        </button>
                      )}
                    </div>
              ...
              <div ref={statusMenuRef} style={{ position: "relative" }}>
                <button type="button" onClick={() => { setShowStatusMenu(v => !v); setShowSortMenu(false); }}
                  style={{ display: "flex", alignItems: "center", gap: 6, border: `1px solid ${theme.cardBorder}`, borderRadius: 8, padding: "7px 14px", cursor: "pointer", fontSize: 13, color: theme.textSub, background: theme.card, fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif" }}>
                  ...
                  <div style={{ position: "absolute", top: "calc(100% + 6px)", right: 0, zIndex: 100, background: theme.dropdownBg, border: `1px solid ${theme.dropdownBorder}`, borderRadius: 10, padding: 6, minWidth: 140, boxShadow: "0 8px 24px rgba(0,0,0,0.08)" }}>
                    {[{val: "all", label: t.all}, {val: "BUILD", label: t.building}, {val: "FLIP", label: t.pivoting}, {val: "KILL", label: t.killed}].map(({val, label}) => (
                      <button key={val} type="button" onClick={() => { setStatusFilter(val as any); setShowStatusMenu(false); }}
                        style={{ display: "block", width: "100%", padding: "8px 12px", border: "none", borderRadius: 7, background: statusFilter === val ? theme.hover : "transparent", cursor: "pointer", fontSize: 13, fontWeight: statusFilter === val ? 600 : 400, color: theme.text, fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif", textAlign: "left" }}>
                        {label}
                      </button>
                    ))}
                  </div>
                  ...
                  <div style={{ position: "absolute", top: "calc(100% + 6px)", right: 0, zIndex: 100, background: theme.dropdownBg, border: `1px solid ${theme.dropdownBorder}`, borderRadius: 10, padding: 6, minWidth: 130, boxShadow: "0 8px 24px rgba(0,0,0,0.08)" }}>
                    {[{val: "newest", label: "Newest first"}, {val: "oldest", label: "Oldest first"}, {val: "az", label: "A → Z"}].map(({val, label}) => (
                      <button key={val} type="button" onClick={() => { setSortOrder(val as any); setShowSortMenu(false); }}
                        style={{ display: "block", width: "100%", padding: "8px 12px", border: "none", borderRadius: 7, background: sortOrder === val ? theme.hover : "transparent", cursor: "pointer", fontSize: 13, fontWeight: sortOrder === val ? 600 : 400, color: theme.text, fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif", textAlign: "left" }}>
                        {label}
                      </button>
                    ))}
                  </div>
          ...
          <div style={{ display: "flex", gap: 0, overflowX: isMobile ? "auto" : "visible", WebkitOverflowScrolling: "touch" as any, scrollbarWidth: "none" as any }}>
            {[{key: "home", label: t.overview}, {key: "ideas", label: t.ideas_tab}, {key: "workspaces", label: t.workspaces}, {key: "settings", label: t.settings_tab}, {key: "profile", label: t.profile_tab}, {key: "billing", label: t.billing_tab}].map(({key, label}) => (
              <button key={key} type="button" onClick={() => setActiveTab(key as any)}
                style={{ padding: "10px 18px", background: "transparent", border: "none", borderBottom: activeTab === key ? `2px solid ${theme.tabActive}` : "2px solid transparent", cursor: "pointer", fontSize: 14, fontWeight: activeTab === key ? 600 : 400, color: activeTab === key ? theme.tabActive : theme.tabInactive, fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif", marginBottom: -1, whiteSpace: "nowrap" }}>
                {label}
              </button>
            ))}
          </div>
                    ...
                    <div key={project.id} style={{ border: `1px solid ${theme.cardBorder}`, borderRadius: 12, padding: "20px 24px", background: "transparent", position: "relative" }}
                      ...
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                          ...
                          <span style={{ fontSize: 13, fontWeight: 400, color: theme.textSub, fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif" }}>{project.status === "building" ? "Building" : project.status === "pivoting" ? "Pivoting" : "Killed"}</span>
                        </div>
          ...
          {activeTab === "settings" && (
            <div style={{ maxWidth: 520 }}>
              ...
              <div style={{ padding: "20px 24px", border: `1px solid ${theme.cardBorder}`, borderRadius: 12, marginBottom: 16 }}>
                ...
                <div style={{ display: "flex", gap: 10 }}>
                  {[{val: false, label: t.light}, {val: true, label: t.dark}].map(({val, label}) => (
                    ...
                    }} style={{ fontSize: 13, padding: "8px 20px", borderRadius: 8, border: darkMode === val ? "2px solid #111" : `1px solid ${theme.cardBorder}`, background: darkMode === val ? "#111" : "#fff", cursor: "pointer", fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif", fontWeight: darkMode === val ? 600 : 500, color: darkMode === val ? "#fff" : "#111" }}>
                      {label}
                    </button>
                  ))}
                </div>
                ...
                <div style={{ display: "flex", gap: 8 }}>
                  {[{val: "en", label: t.english}, {val: "fr", label: t.français}].map(({val, label}) => (
                    <button key={val} type="button"
                      ...
                      style={{ fontSize: 13, padding: "8px 16px", borderRadius: 8, border: selectedLang === val ? "2px solid #111" : `1px solid ${theme.cardBorder}`, background: selectedLang === val ? "#111" : "#fff", cursor: "pointer", fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif", fontWeight: selectedLang === val ? 600 : 500, color: selectedLang === val ? "#fff" : "#111" }}>
                      {label}
                    </button>
                  ))}
                </div>
              ...
              <div style={{ padding: "20px 24px", border: "1px solid #fecaca", borderRadius: 12 }}>
                ...
                <button type="button"
                  style={{ fontSize: 13, padding: "8px 18px", borderRadius: 8, border: "none", background: "#ef4444", color: "#fff", cursor: "pointer", fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif", fontWeight: 600 }}
            ...
            <div style={{ maxWidth: 480 }}>
              ...
              <div style={{ padding: "20px 24px", border: `1px solid ${theme.cardBorder}`, borderRadius: 12, marginBottom: 16 }}>
                ...
                {userPlan !== "scale" && (
                  <button type="button" onClick={() => { const priceId = getPriceIdForUpgrade(userPlan); if (!priceId) return; void handleUpgrade(priceId).catch(() => {}); }}
                    style={{ fontSize: 13, padding: "8px 18px", borderRadius: 8, border: "none", background: theme.ctaBg, color: theme.ctaText, cursor: "pointer", fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif", fontWeight: 600 }}>
                    Upgrade plan →
                  </button>
                )}
              </div>
              ...
              <div style={{ padding: "20px 24px", border: `1px solid ${theme.cardBorder}`, borderRadius: 12, marginBottom: 16 }}>
                ...
                <button type="button" onClick={async () => { const res = await fetch("/api/billing-portal", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ userId: user?.id }) }); const data = await res.json(); if (data.url) window.open(data.url, "_blank"); }}
                  style={{ fontSize: 13, padding: "8px 18px", borderRadius: 8, border: `1px solid ${theme.cardBorder}`, background: theme.card, cursor: "pointer", fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif", fontWeight: 500, color: theme.text }}>
                  Manage billing →
                </button>
              </div>
            ...
            <div style={{ maxWidth: 480 }}>
                ...
                <div>
                  ...
                  <div style={{ display: "flex", gap: 8 }}>
                    <button type="button" onClick={() => openAvatarFilePicker()}
                      style={{ fontSize: 13, padding: "6px 14px", borderRadius: 8, border: `1px solid ${theme.cardBorder}`, background: theme.card, cursor: "pointer", color: theme.text, fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif" }}>
                      {avatarUrl ? "Change" : "Upload"}
                    </button>
                    {avatarUrl && (
                      <button type="button" onClick={() => void removeAvatar()}
                        style={{ fontSize: 13, padding: "6px 14px", borderRadius: 8, border: "1px solid #fecaca", background: theme.card, cursor: "pointer", color: "#ef4444", fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif" }}>
                        Remove
                      </button>
                    )}
                  </div>
              ...
              <div style={{ padding: "20px 24px", border: `1px solid ${theme.cardBorder}`, borderRadius: 12, marginBottom: 16 }}>
                ...
                <input type="text" defaultValue={profileUsername ?? ""} id="profile-username-input"
                  style={{ width: "100%", padding: "9px 12px", border: `1px solid ${theme.cardBorder}`, borderRadius: 8, fontSize: 14, fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif", color: theme.text, background: theme.inputBg, outline: "none", boxSizing: "border-box" }} />
                <button type="button" onClick={async () => {
                  ...
                  style={{ marginTop: 10, fontSize: 13, padding: "8px 18px", borderRadius: 8, border: "none", background: theme.ctaBg, color: theme.ctaText, cursor: "pointer", fontFamily: "'DM Sans', 'Europa Grotesk No 2 SH', sans-serif", fontWeight: 600 }}>
                  Save
                </button>
              </div>
