...
export function CampaignLinksTab({
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      >
        <div style={{ border: "1px solid #EFEFEF", borderRadius: 14, padding: "18px 20px", background: "#FAFAFA" }}>
          <div style={{ fontSize: 12, color: "#9A9A9A", marginBottom: 6 }}>{lang === "fr" ? "Clics" : "Clicks"}</div>
          <div style={{ fontSize: 28, fontWeight: 600, color: "#1A1A1A", letterSpacing: "-0.03em" }}>{totals.clicks}</div>
        </div>
        <div style={{ border: "1px solid #EFEFEF", borderRadius: 14, padding: "18px 20px", background: "#FAFAFA" }}>
          <div style={{ fontSize: 12, color: "#9A9A9A", marginBottom: 6 }}>{lang === "fr" ? "Visiteurs uniques" : "Unique visitors"}</div>
          <div style={{ fontSize: 28, fontWeight: 600, color: "#1A1A1A", letterSpacing: "-0.03em" }}>{totals.uniques}</div>
        </div>
        <div style={{ border: "1px solid #EFEFEF", borderRadius: 14, padding: "18px 20px", background: "#FAFAFA" }}>
          <div style={{ fontSize: 12, color: "#9A9A9A", marginBottom: 6 }}>{lang === "fr" ? "Liens actifs" : "Active links"}</div>
