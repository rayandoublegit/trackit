...
function PricingPageInner() {
  ...
  const t = {
    en: {
      ...
      pricing_locked_signal: "Weekly Check-in",
      pricing_locked_flip: "Milestone Engine",
      pricing_locked_structure: "Market Watch",
      pricing_locked_roadmap: "Pivot Radar",
      pricing_locked_marketing: "Co-Founder Mode",
    },
    fr: {
      ...
      pricing_scale_f5: "Revenue Roadmap",
      pricing_scale_f6: "Marketing Machine",
      pricing_locked_signal: "Check-in hebdomadaire",
      pricing_locked_flip: "Milestone Engine",
      pricing_locked_structure: "Market Watch",
      pricing_locked_roadmap: "Pivot Radar",
      pricing_locked_marketing: "Mode Co-Fondateur",
    },
  }[lang];
