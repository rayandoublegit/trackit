...
const NICHE_MAP: Record<string, string> = {
  ...
  // e-commerce (strict — no ugc / sidehustle / moneymaker pollution)
  ...
  tiktokshop: "e-commerce", dtc: "e-commerce", printondemand: "e-commerce",
  // saas (strict — no generic software / startup / b2b)
  saas: "saas", b2bsaas: "saas", productled: "saas", microsaas: "saas",
};
