...
export function discoveryCopy(lang: Lang) {
  ...
  return {
    ...
    hiddenCreators: fr ? "Créateurs cachés" : "Hidden creators",
    required: fr ? "Requis" : "Required",
    all: fr ? "Tous" : "All",
    enabled: fr ? "Activé" : "On",
    disabled: fr ? "Désactivé" : "Off",
    saveShort: "Save",
    hideCreator: fr ? "Cacher" : "Hide",
    unhideCreator: fr ? "Afficher" : "Unhide",
    relationship: "Relationship",
    profiles: fr ? "Profils" : "Profiles",
    collaborations: "Collaborations",
    noCollaborations: fr ? "Aucune collaboration trouvée." : "No collaborations found.",
    emails: "Emails",
    noEmailShort: fr ? "Email non disponible" : "Email not available",
    campaigns: fr ? "Campagnes" : "Campaigns",
    addShort: "Add",
    addToList: fr ? "Ajouter à une liste" : "Add to a list",
    selectList: fr ? "Sélectionner une liste" : "Select a list",
    noCampaignsYet: fr ? "Aucune campagne." : "No campaigns yet.",
    campaignAdded: fr ? "Ajouté" : "Added",
    creatorAccount: fr ? "Créateur" : "Creator account",
    ...
    performanceBasic: fr ? "Basique" : "Basic",
    performanceAdvanced: fr ? "Avancé" : "Advanced",
    engagementBreakdown: fr ? "Répartition engagement" : "Engagement breakdown",
    ratesDistribution: fr ? "Distribution des taux" : "Rate distribution",
    qualityScores: fr ? "Scores qualité" : "Quality scores",
